...
- :computer: Hands-on experience with HPC environments and data analysis, skilled in Shell scripting, Python, MATLAB, and GitHub ([last project mainly done on HPC sytem](https://github.com/Kristin-2002/Wind_forcing_public))
